...
It was the first time I used the scikit-learn library for my project. It is a vast module which I found challenging at the start but I learned while building the project. Alongside, I used Matplotlib and Numpyfor visualising the data. It was my first application of Machine Learning Technique (Linear Regression) in my academic life. I made sure that each stone was unturned in the project and I will try my best to learn it in my furtherpath.
